namespace sample_4_7.DashboardControls {
  partial class RoomBookingsCurrentYear {
    /// <summary> 
    ...
    private void InitializeComponent() {
      this.placeholder1 = new sample_4_7.DashboardControls.Placeholder();
      this.SuspendLayout();
      // 
      // placeholder1
      // 
